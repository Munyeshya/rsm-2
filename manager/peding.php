 			...
 			<div class="well shadow-sm bg-white p-2">
 				<div class="row">
 					 <div class="col-md-1">
                        ...
                        <h4 class=" font-italic font-weight-normal"><a href="viewpeding.php" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a></h4>
