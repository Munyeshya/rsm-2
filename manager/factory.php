                ...
                <div class="row">
                     <div class="col-md-1">
                        <h4 class=" font-italic font-weight-normal">
                            <a href="psec.php" class="btn-info btn-sm" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i>&nbspBack</a>&nbsp<a href="histor.php" class="btn-info btn-sm" style="text-decoration:none;"><i class="icofont-search-document icofont-1x"></i>&nbspHistory</a>&nbsp<a href="factory.php" class="btn-info btn-sm" style="text-decoration:none;"><i class="icofont-refresh icofont-1x"></i>&nbspRefresh</a></h4>
