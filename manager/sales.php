 	...
 	<div class="row">
 		<div class="col-xl-12">
 			...
 			<div class="well shadow-sm bg-white p-2">
 				<div class="row">
 					 <div class="col-md-4">
                        <h4 class=" font-italic font-weight-normal"><a href="admin.php" class="btn-info btn-sm" style="text-decoration:none; font-size:">Back <i class="icofont-circled-left"></i></a>&nbsp<a href="historys.php" class="btn-info btn-sm" style="text-decoration:none; font-size:">History &nbsp<i class="icofont-search-document"></i></a></h4>
 					 	
 					 </div>
 					 <div class="col-md-12"><br>
 					 	<h4 class="text-center font-italic font-weight-normal">Search An Order:</h4>
 					 </div>
 				</div><br>
 				<div class="row">
 				<div class="col-md-9">
            ...
            if (isset($_POST['sorder'])) {
                $sorder=$_POST['sorder'];
                $query=mysqli_query($conn,"SELECT * from orders where orderid like '%$sorder%' and sales='view' and pm is null ");
            ...
            <p class="alert alert-warning"><a href="salesv.php?id=<?php echo $result; ?>">Approve &nbsp;<i class="icofont-ui-next"></i></a>
                ...
                $query=$conn->query("SELECT DISTINCT(orderid)  from orders where  sales='view' and pm is null  ") or die(mysqli_error($conn)) ;
