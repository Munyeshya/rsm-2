    ...
    <div class="col-md-12">
            <div class="well shadow p-1 bg-light border-bottom border-info">
                ...
                <center><i><b>Rwanda special materials online system<i class="icofont-earth"></i></b></i></p></center><p>
                        <a href="ordering.php" style="text-decoration: none;" class="text-info"><i class="icofont-square-left"></i>&nbsp;Back</a>
            </div>
        </div>
    </div>
 <!--   <div class="row"> -->
        <div class="col-md-12">
            <div class="well shadow-sm bg-white">
                ...
                <div class="row">
                     <div class="col-md-12">
                        <h4 class="text-center font-italic font-weight-normal"><a href="ordering.php?id=<?php echo $Client?>" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a><a href="invoice.php?orderid=<?php echo $id?>" class="text-info" style="text-decoration:none;">|<i class="icofont-refresh icofont-1x"></i></a></h4>
