    ...
    <div class="col-md-12">
            <div class="well shadow p-1 bg-light border-bottom border-info">
                ...
                <center><i><b>Rwanda special materials online system<i class="icofont-earth"></i></b></i></p></center><p>
                        <a href="sales.php" style="text-decoration: none;" class="text-info"><i class="icofont-square-left"></i>&nbsp;Back</a>
            </div>
        </div>
    </div>
 <!--   <div class="row"> -->
        <div class="col-md-12">
            <div class="well shadow-sm bg-white">
                ...
                <div class="row">
                     <div class="col-md-12">
                        <h4 class="text-center font-italic font-weight-normal"><a href="sales.php" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a><a href="salesprint.php?order=<?php echo $id?>" class="text-info" style="text-decoration:none;">|<i class="icofont-refresh icofont-1x"></i></a></h4>
...
<tr><b>
    ...
    <td><?php echo number_format($fin)?></td>
    <td><?php echo number_format($fini)?></td>
    </b>
</tr>
<tr>
...
<tr>
    <td colspan="5" style=" border:none;">
        ...
        $gti=$gtlist['GT'];
        ?>
        GRAND TOTAL: <text style="color:green;"><?php echo number_format($gti)?></text> FRW
    </td>
</tr>
<tr>
    <td colspan="5" style="height:20px; border:none;"></td>
...
<?php
$remain=mysqli_query($conn,"SELECT * FROM moneyhist where orderid='$id' ");
while($rem=mysqli_fetch_array($remain)){
?>
<tr>
    <th style="border:none; font-color:grey; " >Date: <?php echo @$rem['date'];?></th>
    <th colspan="2" style="border:none;">Amount: <?php echo number_format(@$rem['pay1']);?> FRW</th>
    <?php
if (@$rem['pay1']!='0') {
    ?>
    <th style="border:none;">By: <?php echo @$rem['method1'];?></th>
...
$lefty=mysqli_query($conn,"SELECT reste from moneyhist where orderid='$id' order by id desc limit 1 ");
...
?>
    ...
    <tr>
        <td style="border:none" >
            Left:<text style="color:red" ><?php echo number_format( @$check) ?> FRW</text>
        </td>
        <?php }?>
    </tr>
    <tr>
...
<hr>
<text style="font-style:bold; font-size:15; font-family:Arial;">Terms and Conditions for Sale</text><br>
<text style="font-style:italic; font-size:12; font-family:Arial;">1.the client should confirm the goods bought before signing on the order,after signing the customer/client shall not claim for any loss or mistake</text><br>
<text style="font-style:italic; font-size:12; font-family:Arial;">2.the order can only produced after advance payment/full payment is made,goods once sold/ collected are not returnable.</text><br>
<text style="font-style:italic; font-size:12; font-family:Arial;">3.Goods will be kept for free in sales warehouse for a week time if more than a week 0.5% of daily rate until goods are collected.</text><br>
<text style="font-style:italic; font-size:12; font-family:Arial;">4.the buyer shall come or send his/her authorized representative to collect goods.</text><br>
<text style="font-style:bold; font-size:15; font-family:Arial;">I have read and accepted the terms and conditions and signing below.</text><br>
<table>
    <tr>
        <td colspan="5" style="height:20px; border:none;"></td>
    </tr>
</table>
<text style="font-style:bold; font-size:15; font-family:Arial;">Customer Signature..................................</text>
