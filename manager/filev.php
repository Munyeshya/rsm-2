    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="well shadow p-1 bg-light border-bottom border-info">
                ...
                &nbsp;<a href="files.php" style="text-decoration: none;" class="text-info"><i class="icofont-square-left"></i>&nbsp;Back</a>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        Contact:<?php echo $con ?>
            ...
            <th colspan="3">
                ...
                <a href="fctory.php?id=<?php echo $id; ?>" class="btn btn-dark btn-sm"><i class="icofont-paper-plane "></i>Send </a>
                 </div>
            </th>           
