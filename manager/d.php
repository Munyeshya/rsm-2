    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="well shadow-sm bg-white p-2">
                <div class="row">
                     ...
                     <div class="col-md-12"><br>
                        <h4 class="text-center font-italic font-weight-normal">Deliverred Orders:</h4>
                     </div>
                </div><br>
                <div class="row">
                <div class="col-md-9">
            ...
            <p class="alert alert-warning"><a href="peekdeliver.php?id=<?php echo $result; ?>"><i class="icofont-eye-open"></i></a> 
                ...
                $query=mysqli_query($conn,"SELECT DISTINCT(orderid)  from orders where  done='yes' and deliver='delivered' ");
