 ...
 <div class="container">
    ...
    <div class="row">
        ...
        Contact:<?php echo $con ?>
            ...
            <th>
                <a href="salesprint.php?order=<?php echo $id ;?>" class="text-info" style="text-decoration:none;"><i class="icofont-printer icofont-2x"></i></a>
            </th>
            <th>
                
              <!--   <a href="salesap.php?order=<?php echo $id ;?>" class="text-info" style="text-decoration:none;"><i class="icofont-paper-plane icofont-2x"></i></a> -->
            </th>           
