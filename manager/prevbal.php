...
if (isset($_POST['submit'])) {
    ...
    $og=$_POST['origin'];
    $date=date("Y/m/d");
    $query=$conn->query("INSERT INTO prevbal(origin,prev_amount,date) values('$og','$cash','$date')")or die(mysqli_error($conn)) ;
    if ($query) {
 			...
 			<div class="well shadow-sm bg-white p-2">
 				<div class="row">
 					 ...
 					 <div class="col-md-5"><br>
 					 	<h4 class="text-center font-italic font-weight-normal">Starting Balance:</h4>
 					 </div>
 				</div><br>
...
<div id="pdf" >
   ...
   <label><b>STARTING BALANCE REPORT</b></label><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;
   ...
   if(isset($_POST['print'])){
       $edate=$_POST['edate'];
       $sdate=$_POST['sdate'];
       $query=$conn->query("SELECT * from prevbal where date BETWEEN '$sdate' and '$edate'  ");
 ...
 <tr>
     ...
     <td><?php echo $row['prev_amount'] ?></td>
