 	...
 	<div class="row">
 		<div class="col-xl-12">
 			...
 			<div class="well shadow-sm bg-white p-2">
 				<div class="row">
 					 <div class="col-md-4">
                        <h4 class=" font-italic font-weight-normal"><a href="orders.php" class="btn-info btn-sm" style="text-decoration:none; font-size:">Back <i class="icofont-circled-left"></i></a></a></h4>
            ...
            <div class="col-md-2">
            <p class="alert alert-warning"><a href="orpeek.php?id=<?php echo $result; ?>">View &nbsp;<i class="icofont-eye-open"></i></a>

        </div>
       </div>
                <?php 
            }else{  
                $query=mysqli_query($conn,"SELECT DISTINCT(orderid)  from orders where ord='view' ");
