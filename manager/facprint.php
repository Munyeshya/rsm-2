 ...
 <!--   <div class="row"> -->
        <div class="col-md-12">
            <div class="well shadow-sm bg-white">
                ...
                <div class="row">
                     <div class="col-md-12">
                        <h4 class="text-center font-italic font-weight-normal"><a href="filev.php?id=<?php echo $id?>" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a><a href="facprint.php?orderid=<?php echo $id?>" class="text-info" style="text-decoration:none;">|<i class="icofont-refresh icofont-1x"></i></a></h4>
...
<?php 
$list=mysqli_query($conn,"SELECT * from orders where orderid='$id' and itemtype='$a' order by size asc");
while ($row=mysqli_fetch_array($list)) {
    $doublechoice=mysqli_query($conn,"SELECT n from orders where orderid='$id' and  n='n' order by id DESC LIMIT 1");
    $double=mysqli_fetch_array($doublechoice);
    @$choice=$double['n'];
    if ( $choice == '' ) {
...
?>
<tr>
    <td><?php echo $row['n_size']; ?></td>
    <td><?php echo $row['piece']; ?></td>
    <td><?php echo $row['tsn']; ?></td>
...
$lists=mysqli_query($conn,"SELECT * from orders where orderid='$id' and itemtype='$a' order by id desc limit 1");
$start=mysqli_fetch_array($lists);
if ($start['tsn']=='') {
...
$sumup2=mysqli_query($conn,"SELECT SUM(tsn) as tsum  from orders where orderid='$id' and itemtype='$a' ");
$sumu2=mysqli_fetch_array($sumup2);
$sumupu2=$sumu2['tsum'];
