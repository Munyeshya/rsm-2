 			...
 			<div class="well shadow-sm bg-light p-2">
 				<div class="row">
 					 ...
 					 <div class="col-md-4"><br>
 					 	<h4 class="text-center font-italic font-weight-normal"> <a href="admin.php" style="text-decoration: none;" class="text-info"><i class="icofont-circled-left icofont-1x"></i>|&nbsp;</a> <a href="orhistory.php" style="text-decoration: none;" class="text-info">History|&nbsp;</a>Orders<i class="icofont-ui-cart icofont-1x" ></i>:</h4>
 					 </div>
 				</div><br>
 				<div class="row">
 					<div class="col-md-2">
 								...
 								<div class="col-md-12"> 
 									<div class="well shadow-sm bg-light p-3; background color:yellow;" id="fun" >
 										<form method="post" action="" class="form-group">
 											...
 											<label>Client contact</label><br>
 											<input type="text" name="client_contact" class="form-control" required pattern="[0-9]{9}" title="Use correct phone formart"><br>
 					...
 					<div class="col-md-4">
 							<div class="well shadow-sm p-2">
 							<a href="viewpeding.php" class="btn btn-info btn-block rounded-0"><i class="icofont-search-document"></i>Pending Orders</a>
 							<br>
