    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="well shadow-sm bg-white p-2">
                <div class="row">
                     <div class="col-md-2">
                        <h4 class=" font-italic font-weight-normal"><a href="psec.php" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a><a href="waiting.php" class="text-info" style="text-decoration:none;"><i class="icofont-refresh icofont-1x"></i></a>
            ...
            <div class="col-md-3">
            <p class="alert alert-warning"><a href="peek.php?id=<?php echo $result; ?>">View &nbsp;<i class="icofont-ui-next"></i></a>
        </div>
       </div>
                <?php 
            }else{  
