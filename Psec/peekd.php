...
<body class="bg-warning">
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="well shadow p-1 bg-light border-bottom border-info">
                ...
                &nbsp;<a href="psec.php" style="text-decoration: none;" class="text-info"><i class="icofont-square-left"></i>&nbsp;Back</a>
            </div>
        </div>
    </div>
    <div class="row">
 ...
 ?>
                    ...
                    <div class="col-md-4">
                      <form class="form-control shadow-sm" style="height: auto;">
 
<?php  
$my=mysqli_query($conn,"SELECT *from money where orderid='$id'  ");
while ($maersk=mysqli_fetch_array($my)) {
    // code...
?>
<em>
Payment :&nbsp<b><?php echo $maersk['pay1'] ?>FRW</b> <br>
Method:&nbsp<b><?php echo $maersk['method1'] ?></b> <hr>
</em>
<?php }
...
Left:&nbsp<b><?php echo $lefties['reste'] ?>FRW</b>
                            ...
                            <form method="post" class="form-control" style="height: auto;">
                                ...
                                ?>
                                <input type="text" name="driver" placeholder="Driver" class="form-control" value="<?php echo @$drive?>">
                                <input type="text" name="number" placeholder="Tel" class="form-control" value="<?php echo @$num?>">
                                ...
                                <?php 
                                 if (isset($_POST['deliver'])) {
                                    ...
                                    $plate=$_POST['plate'];
                                    $date=date("y-m-d");
                                    $inserte=mysqli_query($conn,"INSERT INTO delivery VALUES('$id','$driver','$tel','$plate','$date') ");
                                    $update=mysqli_query($conn,"UPDATE orders set deliver='delivered' where orderid='$id'");
                                    if ($inserte) {
