    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="well shadow-sm bg-white p-2">
                <div class="row">
                     <div class="col-md-4">
                        <h4 class=" font-italic font-weight-normal"><a href="psec.php" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a><a href="d.php" class="text-info" style="text-decoration:none;"><i class="icofont-refresh icofont-1x"></i></a>
                            <br>
                     ...
                     <div class="col-md-12"><br>
                        <h4 class="text-center font-italic font-weight-normal">Done Orders:</h4>
                     </div>
                </div><br>
                <div class="row">
                <div class="col-md-9">
            ...
            if (isset($_POST['sorder'])) {
                $sorder=$_POST['sorder'];
                $query=mysqli_query($conn,"SELECT * from orders where  done='yes' and deliver='delivered' and orderid like '%$sorder%'");
            ...
            <div class="col-md-2">
            <p class="alert alert-warning"><a href="peekdeliver.php?id=<?php echo $result; ?>"><i class="icofont-eye-open"></i></a> 
        </div>
       </div>
                <?php 
            }else{  
                $query=mysqli_query($conn,"SELECT DISTINCT(orderid)  from orders where vis='invisible' and psec='view' and done='yes' and deliver='delivered' ");
