    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="well shadow p-1 bg-light border-bottom border-info">
                ...
                &nbsp;<a href="waiting.php" style="text-decoration: none;" class="text-info"><i class="icofont-square-left"></i>&nbsp;Back</a>
            </div>
        </div>
    </div>
    <div class="row">
...
?>
<em>
Payment 1:&nbsp<b><?php echo $p1 ?>FRW</b> <br>
Method:&nbsp<b><?php echo $m1 ?></b> <br>
Payment 2:&nbsp<b><?php echo $p2 ?>FRW</b> <br>
Method:&nbsp<b><?php echo $m2 ?></b> <br>
Left:&nbsp<b><?php echo $l ?></b>
</em>
                            </form>  
                    </div>
                     </div>
