    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            if (isset($_POST['sorder'])) {
                $sorder=$_POST['sorder'];
                $query=mysqli_query($conn,"SELECT * from orders where  done='yes' and deliver='' and orderid like '%$sorder%'");
            ...
            <p class="alert alert-warning"><a href="peekd.php?id=<?php echo $result; ?>"><i class="icofont-eye-open"></i></a> 
                ...
                $query=mysqli_query($conn,"SELECT DISTINCT(orderid)  from orders where vis='invisible' and psec='view' and done='yes' and deliver=''");
