    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="well shadow-sm bg-white p-2">
                <div class="row">
                     <div class="col-md-12">
                        <h4 class=" font-italic font-weight-normal"><a href="../logout.php" class="btn-info btn-sm" style="text-decoration:none;"><i class="icofont-logout icofont-1x"></i>Logout</a>&nbsp<a href="files.php" class="btn-info btn-sm" style="text-decoration:none;"><i class="icofont-refresh icofont-1x"></i>Reload</a>
