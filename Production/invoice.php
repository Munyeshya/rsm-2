...
$pdf->Image('../manager/header.png',1.95,0);
...
$remain=mysqli_query($conn,"SELECT * FROM money where orderid='$id' ");
while($rem=mysqli_fetch_array($remain)){

$pdf->Cell(90  ,5,"Payment : ".@$rem['pay1'].' FRW',0,0);
$pdf->Cell(25   ,5,'By: '.@$rem['method1'],0,0);
$pdf->Cell(34   ,5,'',0,1);//end of line
}
...
$pdf->Cell(90  ,5,'Left: '.@$lefties['reste'] ,0,0);
$pdf->Cell(25   ,5,'',0,0);
$pdf->Cell(34   ,5,'',0,1);//end of line
