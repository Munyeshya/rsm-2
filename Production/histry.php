    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="well shadow-sm bg-white p-2">
                <div class="row">
                     <div class="col-md-4">
                        <h4 class=" font-italic font-weight-normal"><a href="pm.php" class="btn-info btn-sm" style="text-decoration:none; font-size:">Back <i class="icofont-circled-left"></i></a>&nbsp<a href="histry.php" class="btn-info btn-sm" style="text-decoration:none; font-size:">Refresh &nbsp<i class="icofont-refresh"></i></a></h4>
            ...
            if (isset($_POST['sorder'])) {
                ...
                $query=mysqli_query($conn,"SELECT * from orders where  pm='view' and file ='view' and orderid like '%$sorder%' ");
            ...
            <p class="alert alert-warning"><a href="salesv.php?id=<?php echo $result; ?>">Approve &nbsp;<i class="icofont-ui-next"></i></a>
                ...
                $query=mysqli_query($conn,"SELECT DISTINCT(orderid)  from orders where  pm='view' and file ='view' ");
...
<?php echo $result; ?>
                ...
                <div class="col-md-3">
            <p class="alert alert-warning"><a href="pmpeek.php?id=<?php echo $result; ?>">View &nbsp;<i class="icofont-eye-open"></i></a>
        </div>
       </div>
       <?php }} ?>
