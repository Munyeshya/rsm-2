 ...
 <!--   <div class="row"> -->
        <div class="col-md-12">
            <div class="well shadow-sm bg-white">
                ...
                <div class="row">
                     <div class="col-md-12">
                        <h4 class="text-center font-italic font-weight-normal"><a href="peekdeliver.php?id=<?php echo $id?>" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a><a href="deliverprint.php?order=<?php echo $id?>" class="text-info" style="text-decoration:none;">|<i class="icofont-refresh icofont-1x"></i></a></h4>
...
$haha=mysqli_query($conn,"SELECT * FROM delivery where orderid='$id'");
...
<tr>
    <td colspan="2" style="height:20px; border:none;"></td>
                         ...
                         ?>
                                 <tr>
                                     <th style="border:none ">Left on :<?php echo $row['itemtype'] ?></th>
                                     <th style="border:none "><?php echo $row['reste'] ?></th>
                                 </tr>
...
DRIVER: <?php echo $drive;?><br>
Tel: <?php echo $num?><br>
Plate: <?php echo $plate ?><br>
Time: <?php echo $time?><br><br>
<text style="color:skyblue; font-style:bold; font-family:Arial;">Sent by:</text>..........................................................................
<br><br>
<text style="color:skyblue; font-style:bold;font-family:Arial;">Recieved by:</text>......................................................................
    </td>
</tr>
