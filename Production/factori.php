    ...
    <div class="row">
        <div class="col-xl-12">
            ...
            <div class="well shadow-sm bg-white p-2">
                <div class="row">
                     <div class="col-md-1">
                        <h4 class=" font-italic font-weight-normal"><a href="production.php" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a><a href="factory.php" class="text-info" style="text-decoration:none;"><i class="icofont-refresh icofont-1x"></i></a></h4>
            ...
            if (isset($_POST['sorder'])) {
                $sorder=$_POST['sorder'];
                $query=mysqli_query($conn,"SELECT * from orders where  factory='view' and done='' and orderid like '%$sorder%'");
            ...
            <p class="alert alert-warning"><a href="comfirm.php?id=<?php echo $result; ?>"><i class="icofont-verification-check"></i></a>
                ...
                $query=mysqli_query($conn,"SELECT DISTINCT(orderid)  from orders where  factory='view' and done='' ");
