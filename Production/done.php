    ...
    <div class="row">
        <div class="col-xl-12">
                ...
                <div class="row">
                     <div class="col-md-4">
                        <h4 class=" font-italic font-weight-normal"><a href="psec.php" class="text-info" style="text-decoration:none;"><i class="icofont-circled-left icofont-1x"></i></a><a href="done.php" class="text-info" style="text-decoration:none;"><i class="icofont-refresh icofont-1x"></i></a>
                            <br>
                            <a href="d.php" class="btn-info btn-sm" style="text-decoration:none; font-size:">Delivered Orders</a>
            ...
            if (isset($_POST['sorder'])) {
                $sorder=$_POST['sorder'];
                $query=mysqli_query($conn,"SELECT * from orders where  done='yes' and deliver is null and orderid like '%$sorder%'");
            ...
            <div class="col-md-2">
            <p class="alert alert-warning"><a href="peekd.php?id=<?php echo $result; ?>"><i class="icofont-eye-open"></i></a> 
        </div>
       </div>
                <?php 
            }else{  
                $query=mysqli_query($conn,"SELECT DISTINCT(orderid)  from orders where vis='invisible' and psec='view' and done='yes' and deliver is null ");
